...
properties = {
  ...
  usePlane: "false", // specifies the tilted workplane command to use
  ...
  useM6: false, // output M6 after TOOL CALL block
...
propertyDefinitions = {
  ...
  useM6: { title: "Use M6 for tool change", description: "Enable to output an M6 code after a TOOL CALL block.", type: "boolean" },
...
var coolants = [
  ...
  { id: COOLANT_AIR },
  { id: COOLANT_AIR_THROUGH_TOOL, on: 27 },
  { id: COOLANT_SUCTION },
  { id: COOLANT_FLOOD_MIST },
  { id: COOLANT_FLOOD_THROUGH_TOOL, on: [8, 7] },
